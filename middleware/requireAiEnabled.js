...
// reaches the points check), /field-assist, and the portrait
// /generate-image route. Deliberately NOT applied to manual-entry save
// (/confirm-entry), /generate-procedural, or /upload-image -- none of
// those call an AI model, and Manual Mode + Roll Randomly + Upload must
// keep working with AI turned off (see the scope addendum).
