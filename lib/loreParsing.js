...
const TOPIC_CATEGORY_MAP = [
  ...
  // Non-core rows: "locations" was missing from all five of these (see
  // ALL_CATEGORIES's comment above) and "spells" from the magic row -- two
  // independent fixes for the same drift (funny-knuth-dfkc3n and
  // hopeful-rubin-fe49ni) merged as a union so both categories ground on
  // the keyword-matched sections, not just the core ones.
  ...
  { re: /technolog|magic|supernatural|power system/i, categories: ["items", "classes", "enemies", "spells", "locations"], core: false },
