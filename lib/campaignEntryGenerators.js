...
async function createNewNpc(worldId, { name, role, faction, campaignContext } = {}) {
  ...
  // world gets a lightweight default combat profile so it's never a
  // hard dead-end if players attack it -- see
  // lib/rulesets/5e/npcCombatDefaults.js. NPCs stay ruleset-agnostic
