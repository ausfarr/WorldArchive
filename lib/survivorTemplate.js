...
function buildSurvivorBodyHtml(survivor, imageUrl) {
  const portraitBlock = `<img class="portrait-img" src="${imageUrl || `images/${survivor.id}.png`}" alt="${escapeHtml(survivor.name)}" onerror="this.outerHTML='&lt;div class=&quot;portrait-slot&quot;&gt;Character portrait — pending&lt;span class=&quot;sub&quot;&gt;art prompt not yet generated&lt;/span&gt;&lt;/div&gt;'">`;
