...
//
// Deliberately does NOT generate an accent color -- that's a bigger,
// separate concern (see routes/wizardStyleGuide.js's batched
// generate-faction-accents, which needs every faction's context at once
// for real cross-faction distinctness). A faction created here just gets
// the same graceful cyan-default fallback as any pre-Style-Guide-step
// faction, overridable via the dossier page's color picker.
