...
function buildLocationBodyHtml(location, imageUrl) {
  ...
  const artBlock = `<img class="portrait-img" src="${imageUrl || `images/${location.id}.png`}" alt="${name}" onerror="this.outerHTML='&lt;div class=&quot;portrait-slot&quot;&gt;Location art — pending&lt;span class=&quot;sub&quot;&gt;art prompt not yet generated&lt;/span&gt;&lt;/div&gt;'">`;
