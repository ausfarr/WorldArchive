...
async function resetWorldConfig(worldId) {
  ...
  const { error } = await supabase
    .from("world_config")
    .update({ draft_json: {}, factions_json: [], lore_doc_ref: null, stat_system_json: null, skill_system_json: null, style_guide_json: null, category_config_json: null, generic_system_json: null, setup_completed_at: null, ruleset: "echoes" })
    .eq("world_id", worldId);
