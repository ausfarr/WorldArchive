...
const PRINT_CSS = `
  ...
  .pdf-toc li { padding: 4px 0; border-bottom: 1px dotted #ccc; font-size: 0.85rem; }
  .pdf-toc a { color: inherit; text-decoration: none; }
  .pdf-entry { page-break-after: always; }
  .pdf-entry:last-child { page-break-after: avoid; }
  .pdf-entry .portrait-img { max-width: 260px; max-height: 260px; border: 1px solid #ccc; }
  .pdf-category-heading { page-break-before: always; }
  .pdf-category-heading:first-of-type { page-break-before: avoid; }
  .sheet, .sheet-header, .sheet-body { background: transparent !important; border-color: #ccc !important; box-shadow: none !important; }
  .rel-table, .rel-table td, .rel-table th { border-color: #ccc !important; }
`;
