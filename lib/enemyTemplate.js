...
function buildEnemyBodyHtml(enemy, imageUrl, statLabels) {
  ...
  const portraitBlock = `<img class="portrait-img" src="${imageUrl || `images/${enemy.id}.png`}" alt="${name}" onerror="this.outerHTML='&lt;div class=&quot;portrait-slot&quot;&gt;Character portrait — pending&lt;span class=&quot;sub&quot;&gt;art prompt not yet generated&lt;/span&gt;&lt;/div&gt;'">`;
