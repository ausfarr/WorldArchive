...
const DEFAULT_NPC_COMBAT_PROFILE = {
  ruleset: "5e", // lib/entryTemplate.js's combatProfileBlock() reads this to pick the right embedded renderer -- see that file's comment for why it defaults to '5e' when absent (every profile saved before this field existed).
  armorClass: 10,
  armorNote: null,
  hitPoints: 4,
  hitDice: "1d8",
