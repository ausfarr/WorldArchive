...
const campaignModuleRoute = require("./routes/campaignModule");
const campaignArcRoute = require("./routes/campaignArc");
...
const reference5eRoute = require("./routes/reference5e"); // R4 Phase 5 -- static Background/Feat reference lists
...
app.use("/api", campaignModuleRoute);
app.use("/api", campaignArcRoute);
