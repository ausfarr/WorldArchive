...
const EXISTING_PORTRAIT_URL = "https://fake-storage.test/portraits/test-world/existing-npc.png";
...
function seedNpc(id, { withPortrait }) {
  db.entries.push({
    world_id: WORLD,
    category: "npcs",
    entry_id: id,
    ...
    body_html: withPortrait
      ? `<img class="portrait-img" id="portrait-img-${id}" data-category="npcs" data-entry-id="${id}" data-label="Character portrait" src="${EXISTING_PORTRAIT_URL}" alt="Vess Okoro">`
