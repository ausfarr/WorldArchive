...
<title>Bestiary — The Archive</title>
...
<div class="wrap">
  <div class="crumb"><a href="../index.html">Archive</a><span class="sep">/</span><span>Bestiary</span></div>
  <h1 style="font-family: var(--font-display); text-transform: uppercase; margin: 20px 0 8px;">Bestiary</h1>
  <p style="color: var(--ink-dim); max-width: 640px; margin: 0 0 24px;">Trash, Elite, and Boss-tier threats. Stat blocks, ability kits, combat notes.</p>
...
<script>
  renderCategoryIndex(window.MANIFEST_ENEMIES, "enemies");
</script>
